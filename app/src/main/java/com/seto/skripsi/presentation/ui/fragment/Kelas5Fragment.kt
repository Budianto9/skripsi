...
import com.seto.skripsi.databinding.FragmentKelas5Binding
...
class Kelas5Fragment : Fragment() {

    private var _binding: FragmentKelas5Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKelas5Binding.inflate(inflater, container, false)
            ...
            if (surah != null){
                when(surah){
                    ...
                    is Resource.Success ->{
                        ...
                        surahAdapter.setData(surah.data?.slice(40..49))
                    }
                    is Resource.Error ->{
